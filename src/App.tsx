...
const App: React.FC = () => {
    ...
    // Optimization: Memoize callback to maintain stable reference for child components
    ...
    // Optimization: specific handler with stable reference to prevent RecipeCard re-renders
    const handleRecipeClick = React.useCallback(async (recipe: Recipe) => {
