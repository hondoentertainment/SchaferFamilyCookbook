            ...
            {selectedRecipe && (
                <Suspense fallback={<div className="fixed inset-0 z-[100] bg-stone-900/60 flex items-center justify-center" aria-label="Loading recipe"><span className="animate-pulse text-white">Loading…</span></div>}>
                    <RecipeModal
                        ...
                        breadcrumbContext={{ Recipes: 'Recipes', Index: 'A–Z', 'Meal Plan': 'Meal Plan', Gallery: 'Gallery', Trivia: 'Trivia', 'Family Story': 'Family Story', Contributors: 'Contributors', Profile: 'Profile', Privacy: 'Privacy', 'Grocery List': 'Grocery List' }[tab] ?? 'Recipes'}
