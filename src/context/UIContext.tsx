    ...
    return (
        <UIContext.Provider value={{ toast, confirm }}>
            ...
            <div
                ...
                className="fixed bottom-[var(--app-bottom-nav-clearance)] md:bottom-6 left-1/2 -translate-x-1/2 z-[300] flex w-[min(92vw,32rem)] flex-col gap-2 pointer-events-none"
                aria-live="polite"
                aria-atomic="true"
            >
                {toasts.map(t => (
