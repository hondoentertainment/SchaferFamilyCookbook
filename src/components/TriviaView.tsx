                    ...
                    {status === 'error' && (
                        <div className="py-4 text-sm text-stone-500 dark:text-stone-400 space-y-3" role="alert">
                            ...
                            <button
                                type="button"
                                onClick={onRefresh}
                                className="text-[10px] font-black uppercase tracking-widest text-[var(--color-brand)] dark:text-[#A0C4A0] hover:underline"
                            >
                                Try again
                            </button>
                        </div>
                ...
                {scores.map((s, i) => (
                    ...
                    >
                        <span className="flex items-center gap-3">
                            <span className="text-stone-400 dark:text-stone-500 w-6 text-right font-mono">{i + 1}.</span>
                            <span className="font-serif text-stone-700 dark:text-stone-200">{s.playerName}</span>
                            {s.id === highlightId && (
            ...
            <div className={`${TRIVIA_SHELL} animate-in slide-in-from-bottom-8 duration-500`}>
                <div className="flex justify-between items-center">
                    <button
                        ...
                        className="text-[10px] font-black uppercase tracking-widest text-stone-400 hover:text-[var(--color-brand)] transition-colors"
                    >
                        ← Back to results
                    </button>
                ...
                <div className="bg-white dark:bg-[var(--card-bg)] rounded-[3rem] p-6 md:p-12 border border-stone-100 dark:border-stone-800 shadow-2xl space-y-6">
                    ...
                    {log && (
                        <div className="space-y-4">
                            ...
                            {q.explanation && (
                                <div className="p-4 bg-orange-50/50 dark:bg-amber-900/20 rounded-2xl text-sm italic text-[#A0522D] dark:text-amber-300 font-serif">
                                    {q.explanation}
                                </div>
                            )}
                        </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-[var(--color-brand)] text-white rounded-full text-[10px] font-black uppercase tracking-widest disabled:opacity-40 disabled:cursor-not-allowed hover:bg-[#3d5745] transition-all"
                    >
                        Next
                    </button>
                </div>
            ...
            <div className={`${TRIVIA_SHELL} text-center animate-in zoom-in duration-700`}>
                ...
                <div className="flex flex-col items-center gap-6">
                    <div className="flex flex-wrap justify-center gap-4">
                        <button
                            onClick={startQuiz}
                            className="px-10 py-4 bg-stone-100 text-[var(--color-brand)] rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[var(--color-brand)] hover:text-white transition-all shadow-md"
                        >
                            Try Again
                        </button>
                        <button
                            onClick={() => setReviewMode(true)}
                            className="px-10 py-4 bg-white dark:bg-[var(--card-bg)] border-2 border-[var(--color-brand)] text-[var(--color-brand)] dark:text-emerald-300 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[var(--color-brand)] hover:text-white transition-all shadow-md"
                        >
                            Review answers
                        </button>
                    </div>
    ...
    return (
        <div className={`${TRIVIA_SHELL} animate-in slide-in-from-bottom-8 duration-500`}>
            ...
            <div className="bg-white dark:bg-[var(--card-bg)] rounded-[3rem] md:rounded-[4rem] p-6 md:p-16 border border-stone-100 dark:border-stone-800 shadow-2xl relative overflow-hidden group">
                    ...
                    >
                        {selectedOption === currentQuestion.answer ? (
                            ...
                            <div className="flex items-start gap-4">
                                <span className="text-4xl text-stone-400 dark:text-stone-500">✗</span>
                ...
                {isAnswered && (
                    <div className="mt-12 pt-10 border-t border-stone-50 dark:border-stone-700 animate-in fade-in slide-in-from-top-4 duration-500 text-center space-y-8">
                        ...
                        {currentQuestion.explanation && (
                            <div className="p-6 bg-orange-50/50 dark:bg-amber-900/20 rounded-[2rem] text-sm italic text-[#A0522D] dark:text-amber-300 font-serif leading-relaxed">
                                {currentQuestion.explanation}
                            </div>
                        )}
                        <button
                            onClick={nextQuestion}
                            className="px-12 py-4 bg-[var(--color-brand)] text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-brand)]"
                        >
