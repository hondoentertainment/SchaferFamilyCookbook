...
import { AdminRecordsTab } from './admin/AdminRecordsTab';
import { AdminGalleryTab } from './admin/AdminGalleryTab';
import { AdminTriviaTab } from './admin/AdminTriviaTab';
import { AdminDirectoryTab, AdminPermissionsTab } from './admin/AdminDirectoryTab';
...
export const AdminView: React.FC<AdminViewProps> = (props) => {
    const { toast } = useUI();
    const {
        editingRecipe, clearEditing, recipes, trivia, contributors,
        currentUser, dbStats, onAddRecipe, onAddGallery, onAddTrivia,
        onDeleteTrivia, onDeleteRecipe, onUpdateContributor,
        onUpdateArchivePhone, onEditRecipe, defaultRecipeIds = [],
        firebaseCustodian,
    } = props;
