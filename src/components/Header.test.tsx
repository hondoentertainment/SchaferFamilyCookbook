...
describe('Header', () => {
    ...
    it('should show a where-am-I location chip and mark Recipes current on A–Z', () => {
        renderWithProviders(<Header {...defaultProps} activeTab="Index" />);
        expect(screen.getByTestId('header-location')).toHaveTextContent('Recipes · A–Z');
