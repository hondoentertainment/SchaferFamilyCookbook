/**
 * Deterministic Recipe of the Week pick.
 * Used by: src/utils/recipeOfTheWeek.ts (HomeView card) and
 * api/recipe-of-the-week.ts (weekly push cron) — one implementation so the
 * card on Home and the push notification always name the same recipe.
 */
 ...
 * pick doesn't depend on fetch order. Works on any array of `{ id }` objects.
 */
export function recipeOfTheWeek(recipes, date = new Date()) {
